...
// Source-map upload and build-time rewriting require an auth token. Keeping the
// plugin disabled without one also avoids spawning needless loader workers locally.
