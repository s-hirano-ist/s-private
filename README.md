...
必要な GitHub Secrets:
- アプリ環境変数: `DATABASE_URL`, `AUTH0_CLIENT_ID`, `AUTH0_CLIENT_SECRET`, `AUTH0_ISSUER_BASE_URL`, `SENTRY_AUTH_TOKEN`, `SENTRY_REPORT_URL`, `MINIO_HOST`, `MINIO_BUCKET_NAME`, `MINIO_ACCESS_KEY`, `MINIO_SECRET_KEY`, `PUSHOVER_USER_KEY`, `PUSHOVER_APP_TOKEN`, `EMBEDDING_API_URL`, `QDRANT_URL`, `NEXT_PUBLIC_SENTRY_DSN`
