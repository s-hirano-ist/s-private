...
function Textarea({ className, ref, ...props }: TextareaProps) {
	return (
		<textarea
			className={cn(
				"sui:flex sui:min-h-[60px] sui:w-full sui:rounded-md sui:border sui:border-muted sui:bg-transparent sui:px-3 sui:py-2 sui:text-base sui:shadow-xs sui:placeholder:text-muted-foreground sui:focus-visible:ring-1 sui:focus-visible:ring-primary sui:focus-visible:outline-hidden sui:disabled:cursor-not-allowed sui:disabled:opacity-50",
				className,
			)}
			ref={ref}
			{...props}
