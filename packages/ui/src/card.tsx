...
function Card({ className, ref, ...props }: CardProps) {
	return (
		<div
			className={cn(
				"sui:rounded-xl sui:border sui:border-muted sui:bg-primary-foreground sui:text-primary sui:shadow-sm sui:transition-all sui:duration-200 sui:ease-out",
				className,
			)}
			ref={ref}
			{...props}
...
function CardHeader({ className, ref, ...props }: CardHeaderProps) {
	return (
		<div
			className={cn("sui:flex sui:flex-col sui:space-y-1 sui:p-4", className)}
			ref={ref}
			{...props}
		/>
	);
...
function CardTitle({ className, ref, ...props }: CardTitleProps) {
	return (
		...
		<h3
			className={cn(
				"sui:bg-clip-text sui:leading-normal sui:font-bold sui:tracking-tight",
				className,
			)}
			ref={ref}
			{...props}
...
function CardContent({ className, ref, ...props }: CardContentProps) {
	return (
		<div className={cn("sui:p-4 sui:pt-0", className)} ref={ref} {...props} />
	);
}
...
function CardFooter({ className, ref, ...props }: CardFooterProps) {
	return (
		<div
			className={cn("sui:flex sui:items-center sui:p-4 sui:pt-0", className)}
			ref={ref}
			{...props}
		/>
	);
