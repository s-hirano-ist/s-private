import type { ArticleCreatedEvent } from "@s-hirano-ist/s-core/articles/events/article-created-event";
import type { ArticleDeletedPayload } from "@s-hirano-ist/s-core/shared-kernel/events/payload-types";
