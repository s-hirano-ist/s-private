import type { ImageDeletedEvent } from "@s-hirano-ist/s-core/images/events/image-deleted-event";
import type { ImageCreatedPayload } from "@s-hirano-ist/s-core/shared-kernel/events/payload-types";
